...
class SamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sample" do
    assert_difference('Sample.count') do
      post samples_url, params: { sample: { area: @sample.area, location: @sample.location, name: @sample.name } }
    end
  ...
  test "should update sample" do
    patch sample_url(@sample), params: { sample: { area: @sample.area, location: @sample.location, name: @sample.name } }
